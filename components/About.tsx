...
import { FadeIn, StaggerContainer, StaggerItem, Parallax, AnimatedCounter, ImageReveal } from './ScrollAnimations';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <motion.div
              className="absolute -top-10 -left-10 w-64 h-64 bg-brand-primary/20 rounded-full blur-3xl"
            ...
            {/* Floating Badge */}
            <motion.div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-full shadow-xl text-center w-40 h-40 flex flex-col justify-center items-center z-10 border-4 border-brand-bg"
              initial={{ scale: 0, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
              viewport={{ once: true }}
            ...
            >
              <span className="font-serif text-4xl font-bold text-brand-secondary">
                <AnimatedCounter value={parseInt(COPY.about.badgeNumber)} suffix="+" />
              </span>
              ...
              {COPY.about.values.map((value, index) => {
                ...
                return (
                  <StaggerItem key={index}>
                    ...
                    >
                      <motion.div
                        className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-brand-primary shadow-sm"
